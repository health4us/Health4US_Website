...
export const getFullMediaData = async (mediaData, callback) => {
    if (mediaData.videoId) {
        await getFullVideoData(mediaData.videoId, callback);
    }
    callback();
};

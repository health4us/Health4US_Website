...
const routerFactory = (
	...
	const changeHashBangUrlFixExperimentOn = !!experiments['specs.thunderbolt.changeHashBangUrlFix']
	...
	const isInternalValidRoute = (url: string): boolean => {
		const routeInfo = resolveUrl(url, routingConfig, { changeHashBangUrlFixExperimentOn })

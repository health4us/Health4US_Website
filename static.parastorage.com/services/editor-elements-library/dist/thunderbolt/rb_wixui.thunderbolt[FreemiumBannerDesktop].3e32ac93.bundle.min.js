    ...
    return function() {
        ...
        return function() {
            ...
            var o = function() {
                ...
                l = r(5329);
            const i = e => Object.entries(e).reduce(((e, [t, a]) => (t.includes("data-") && (e[t] = a), e)), {});
            const s = e => {
                    let {
                        rootClass: t,
                        dotClass: a
            ...
            const p = d(32),
                ...
                v = (e, a) => {
                    ...
                    return void 0 !== r ? l.createElement("a", t()({}, i(e), {
                        "data-testid": h,
                        "data-popupid": d,
                        "data-anchor": v,
                        "data-anchor-comp-id": x,
                        href: r || void 0,
                        target: o,
                        role: d ? "button" : n,
                        rel: s,
            ...
            var x = l.forwardRef(v);
            const y = "bannerOverlay",
                h = "bannerLogo";
            var E = "{Wix}",
                k = {
                ...
                FreemiumBannerDesktop: {
                    component: e => {
                        const {
                            ...
                            classNames: d = [g],
                            className: p
                        } = e, f = o(...d.map((e => k[e])), k.desktopTop, "has-custom-focus"), b = r.bannerText.indexOf(E) >= 0;
                        let m = r.bannerText,
                            v = "";
                        if (b) {
                            const e = r.bannerText.split(E);
                            m = e[0], v = e[1]
                        }
                        return l.createElement("div", t()({
                            id: a
                        }, i(e), {
                            className: o(p, k.desktop, k.freemiumBanner)
                        ...
                        }, l.createElement("div", null, l.createElement(s, {
                            rootClass: k.wixLogo,
                            dotClass: k.dot
                        })), l.createElement("div", {
                            className: k.com
                        }, ".com")), v), l.createElement("span", {
                            className: k.button + " " + k[c]
                        }, r.buttonText))))
                    }
                }
            }
...
//# sourceMappingURL=https://static.parastorage.com/services/editor-elements-library/dist/thunderbolt/rb_wixui.thunderbolt[FreemiumBannerDesktop].3e32ac93.bundle.min.js.map